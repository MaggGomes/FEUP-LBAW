                                    ...
                                    <div class="dropdown horizontal-menu">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            {if $smarty.session.id == $article.userid}
                                                <li><a href="edit_article.php?id={$article.id}"><span
                                                                class="fa fa-pencil-square-o" aria-hidden="true"></span><span
                                                                class="menu-text"> &nbsp;Edit article</span></a></li>
                                            {/if}
                                            {if $smarty.session.id == null}
                                            <li><a href="#report-article" onclick="openRepArticle(false,{$article.id})"><span
                                                            class="fa fa-flag" aria-hidden="true"></span>
                                                    {else}
                                            <li><a href="#report-article" data-toggle="modal"
                                                   onclick="openRepArticle(true,{$article.id})"><span class="fa fa-flag"
                                                                                                      aria-hidden="true"></span>
                                                    {/if}
                                                    <span class="menu-text"> &nbsp;Report article</span></a></li>
                                            <li><a href="#"><span class="fa fa-eye-slash"
                                                                  aria-hidden="true"></span><span class="menu-text"> &nbsp;Hide article</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
