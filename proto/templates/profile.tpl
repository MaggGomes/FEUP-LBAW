        ...
        <div class="profile-head">
            <div class="profiles col-xs-12 col-sm-10 col-sm-push-1 col-md-8 col-md-push-2 thumbnail">
                ...
                <div class="col-sm-9 profile-description">
                    <div class="row">
                        <span class="col-xs-12"><h2>Roy Larsson</h2></span>
                        <div class="col-md-4 col-xs-12 profile-presentation">
                            <div class="row">
                                <div class="col-md-12"><span class="profile-follow">88</span> Following &middot; <span class="profile-follow">200</span> Followers</div>
                            </div>
...
<section class="central">
    ...
    <div class="container profile-articles">
        <div class="row container-category-title">
            <h3 class="col-sm-10 col-sm-push-1 col-md-8 col-md-push-2 ">Articles by Roy Larsson <span class="glyphicon glyphicon-menu-down"></span></h3>
        </div>
        <div class="row">
