...
<header>
            ...
            <nav>
                <div id="logo">
                    <a href="home.php"><img src="../res/images/logoheader.png">
                        <div id="texto"><p>scriba</p></div>
                    </a>
                </div>
                <div id="menu">
                    <ul>
                        <li class="header-button"><a href="home.php">Homes</a></li>
                        <li class="header-button"><a href="list_restaurants.php">Top Articles</a></li>
                        <li class="header-button"><a href="list_restaurants.php">Politics</a></li>
                        <li class="header-button"><a href="list_restaurants.php">Culture</a></li>
                        <li class="header-button"><a href="list_restaurants.php">Sports</a></li>
                        <li class="header-button"><a href="list_restaurants.php">Technology</a></li>
                    </ul>
                </div>
                 ...
                 <?php } else { ?>
                   ...
                   <?php } } else { ?>
                    <div id="user" class="dropdown">
                        <button type="button" id="btn-user" title="Entrar/Registar"><img src="../res/images/user.png"></button>
                        <div class="menu-dropdown">
                            <a href="#" id="btn-login"><i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Sign in</a>
                            <a href="#" id="btn-register"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Register</a>
                        </div>
                    </div>
                <?php } ?>
            </nav>
    ...
    <section id="backg">
        <div id="search">
            <p>Beyond the words</p> <br><br>
            <form class="search-restaurants" action="list_restaurants.php" method="get" autocomplete="off">
                                <input type="text" name="search" value="<?php echo($_SESSION['search']); ?>" alt="Search Restaurants" placeholder="Search an article..." id="searchbar"/>
                <input type="submit" value="Search" id="butt-search">
