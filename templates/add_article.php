        ...
        <article id="addrestaurant">
            ...
            <article class="box col-md-10">
                <form action="../actions/action_add_restaurant.php" method="post">
                    <div class="col-md-12">
                        <h4>Title</h4>
                        <input type="text" name="title" class="col-md-10" placeholder="Article title" required>
                    </div>
                    <div class="col-md-12">
                        <h4>Field</h4>
                        <textarea rows="10" name="body" class="col-md-10" required></textarea>
                    </div>
                    <div class="col-md-12">
                        <h4>Category</h4>
                        <div class="col-md-2">
                    ...
                    <div class="col-md-12">
                        <h4>Tags</h4>
                        <input type="text" class="col-md-10" name="tags">
                    </div>
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-block" disabled>Create article</button>
                    </div>
                </form>
            </article>
        </article>
